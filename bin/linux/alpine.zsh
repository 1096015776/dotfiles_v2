...
apk add --no-cache neovim lazygit fd ripgrep jq alpine-sdk delta tmux yazi yazi-cli fd zsh bash zip npm figlet nginx fzf lua-language-server stylua tree-sitter-cli fastfetch curl 7zip file bat eza git-svn subversion procps openssh-client
