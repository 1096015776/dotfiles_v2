return {
  ...
  config = function()
    ...
    map("n", "<Leader>dbc", dap.clear_breakpoints, { desc = "Clear All" })
    map("n", "<Leader>dbl", dap.list_breakpoints, { desc = "List All" })
    map("n", "<Leader>dn", dap.step_over, { desc = "Step Over" })
    map("n", "<Leader>di", dap.step_into, { desc = "Step Over" })
    map("n", "<Leader>do", dap.step_out, { desc = "Step Over" })
